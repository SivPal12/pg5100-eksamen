...
insert into Concert ( id, date, description, location, name, numtickets, price, artist_id, ticketssold) values ( 1, '2015-01-11', 'Desc', 'Loc', 'Concert name1', 500, 9001, 1, 0),( 2, '2015-02-12', 'Desc', 'Loc', 'Concert name2', 500, 9001, 2, 0),( 3, '2015-03-13', 'Desc', 'Loc', 'Concert name3', 500, 9001, 3, 0),( 4, '2015-04-14', 'Desc', 'Loc', 'Concert name4', 500, 9001, 4, 0);
